...
Config.define('TC_AWS_REGION', 'cn-northwest-1', 'S3 region', 'S3')
...
Config.define('TC_AWS_LOADER_BUCKET', 'image-handler', 'S3 bucket for loader', 'S3')
...
Config.define('TC_AWS_ENDPOINT', 'https://s3.cn-northwest-1.amazonaws.com.cn', 'Custom AWS API endpoint', 'S3')
